...
with open("models/tech_nontech_model.pkl", "rb") as model_file:
    tech_model = pickle.load(model_file)

with open("models/tech_nontech_vectorizer.pkl", "rb") as vectorizer_file:
    vectorizer = pickle.load(vectorizer_file)

# For domain classification (e.g., AI, Web Development, etc.)
with open("models/domain_model.pkl", "rb") as domain_model_file:
    domain_model = pickle.load(domain_model_file)

with open("models/domain_vectorizer.pkl", "rb") as domain_vectorizer_file:
